...
def generate_link_info_for_response_model(title: str, route: str, desc: str) -> LinkResponse:
    """
    ...
    """
    return LinkResponse(title=title, 
                        detail=LinkDetailResponse(route=route, 
                                                    description=desc))
